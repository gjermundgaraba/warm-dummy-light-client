...
pub struct InstantiateMsg {
    ...
    /// The checksum of the client state.
    pub checksum: Binary,
}
...
pub mod query_responses {
    ...
    impl TryFrom<ibc_client_cw::types::QueryResponse> for Status {
        ...
        fn try_from(
            ...
            Ok(Self {
                status: query_response.status.unwrap(),
            })
        }
    }
    ...
    impl TryFrom<ibc_client_cw::types::QueryResponse> for ExportMetadata {
        ...
        fn try_from(
            ...
            Ok(Self {
                metadata: query_response.genesis_metadata.unwrap(),
            })
        }
    }
    ...
    impl TryFrom<ibc_client_cw::types::QueryResponse> for TimestampAtHeight {
        ...
        fn try_from(
            ...
            Ok(Self {
                timestamp: query_response.timestamp.unwrap(),
            })
        }
    }
    ...
    impl TryFrom<ibc_client_cw::types::QueryResponse> for CheckForMisbehaviour {
        ...
        fn try_from(
            ...
            Ok(Self {
                found_misbehaviour: query_response.found_misbehaviour.unwrap(),
            })
        }
    }
}
